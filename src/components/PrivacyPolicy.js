...
const PrivacyPolicy = () => {
  return (
    <div>
      <Helmet>
        <title>Privacy Policy | Ruturaj Enterprises</title>

        <meta
          name="description"
          content="Privacy Policy for Ruturaj Enterprises. Learn how we collect, use, and protect your personal information while using our cab booking, airport transfer, local and outstation travel services."
        />

        <meta
          name="keywords"
          content="Ruturaj Enterprises, Cab Service, Taxi Booking, Airport Transfer, Outstation Travel, Privacy Policy"
        />
      </Helmet>
      ...
      <section className="privacy-policy">
        <div className="container px-0">
          ...
          <div className="row g-0">
            <img src="/images/privacy.png" alt="Privacy Ruturaj Enterprises" />

            <div className="col-12 col-md-12">
              <h3 className="title">Privacy Policy – Ruturaj Enterprises</h3>

              <p>
                At <b>Ruturaj Enterprises</b>, we value your privacy and are committed
              ...
              <div className="section">
                ...
                <p>
                  Ruturaj Enterprises follows reasonable security practices to protect your
                ...
                <p>
                  Ruturaj Enterprises is not responsible for the privacy practices of external
